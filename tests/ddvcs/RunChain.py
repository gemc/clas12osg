...
print ("Job1 id is %d    Label 1 is %s" %(job1_id, comment_1))
print ("Job2 id is %d    Label 2 is %s" %(job2_id, comment_2))
print ("Job3 id is %d    Label 3 is %s" %(job3_id, comment_3))

MergedFilesDir = "/volatile/clas12/ungaro/OSG_Validation/Merged_Outputs/";
OSGBaseDir = "/volatile/clas12/osg2/ungaro"
