...
void OSG_Validate(int job1, std::string comment1, int job2, std::string comment2, int job3, std::string comment3) {
    ...
    // create strings from comment1, comment2, comment3 with spaces replaced by _
    std::string label1 = comment1;
    std::replace(label1.begin(), label1.end(), ' ', '_');
    std::string label2 = comment2;
